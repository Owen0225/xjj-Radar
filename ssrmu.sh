...
Set_config_user(){
	...
	stty erase '^H' && ssr_user="xjjPUBG"
	[[ -z "${ssr_user}" ]] && ssr_user="xjjPUBG"
...
Set_config_password(){
	echo "请输入要设置的用户 密码"
	stty erase '^H' && ssr_password="xjjPUBG"
	[[ -z "${ssr_password}" ]] && ssr_password="xjjPUBG"
